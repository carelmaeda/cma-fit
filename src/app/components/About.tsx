          ...
          {isExpanded && (
            <div className="expanded-content">
              <p>
                ...
                strength and conditioning coaches, shaping the foundation of my
                approach to training. I&apos;ve coached professional athletes
                through combine prep, guided youth athletes toward earning
                scholarships, and helped countless clients reach their next
                level—whether it&apos;s stepping onto the field, hitting a
                personal best, or simply moving pain-free.
              </p>
              <p>
                After herniating three discs in my lower back, I dove deep into
                rehabilitation and injury prevention. That experience redefined
                my philosophy around training—now, I focus not just on
                performance, but longevity, function, and resilience.
              </p>
              <p>
